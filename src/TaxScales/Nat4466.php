...
class Nat4466 extends BaseCoefficientScale
{
    ...
    protected array $scaledCoefficients = [
        ...
        '2026-07-01' => [
            'single' => [
                ...
                851 => [0.284, 190.3413],
                865 => [0.384, 275.4721],
                1036 => [0.5277, 399.8279],
                1064 => [0.4027, 270.3231],
                1282 => [0.3227, 185.1923],
                2596 => [0.32, 181.7319],
                3653 => [0.39, 363.4627],
            ...
            'single-hmle' => [
                ...
                865 => [0.284, 190.3413],
                1036 => [0.4277, 314.6971],
                1185 => [0.3027, 185.1923],
                1282 => [0.3527, 244.4452],
                1481 => [0.35, 240.9837],
                2596 => [0.31, 181.7308],
                3653 => [0.38, 363.4615],
    ...
    public function getCoefficients(Payer $payer, Payee $payee, Earning $earning): array
    {
        ...
        if (
            Date::from($earning->getPayDate(), '2024-07-01') &&
            $payee->getMedicareLevyExemption() === Payee::MEDICARE_LEVY_EXEMPTION_FULL
        ) {
            ...
            Date::from($earning->getPayDate(), '2024-07-01') &&
            $payee->getMedicareLevyExemption() === Payee::MEDICARE_LEVY_EXEMPTION_HALF
        ) {
            if ($payee->getSeniorsOffset() === Payee::SENIORS_OFFSET_SINGLE) {
